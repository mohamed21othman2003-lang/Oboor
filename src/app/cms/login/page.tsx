          ...
          <div className="rounded-[28px] bg-white p-8 shadow-[0_20px_60px_-24px_rgba(15,108,115,0.35)] ring-1 ring-[#e8f1f1] sm:p-10">
            ...
            <form onSubmit={submit} className="mt-8 space-y-4">
              <div>
                ...
                <div className="relative">
                  <span className="pointer-events-none absolute end-3.5 top-1/2 -translate-y-1/2 text-[#9fb1b2]">
                  ...
                  <input
                    ...
                    required
                    autoFocus
                    className="w-full rounded-2xl border border-[#e2ecec] bg-[#F7FAFA] px-4 py-3.5 pe-11 text-sm text-[#123C40] outline-none transition-colors placeholder:text-[#a9b8b9] focus:border-[#1FA6A8] focus:bg-white focus:ring-4 focus:ring-[#1FA6A8]/15"
                    placeholder="admin"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                  />
                  <button type="button" onClick={() => setShow((s) => !s)} aria-label={show ? t("إخفاء", "Hide") : t("إظهار", "Show")} className="absolute start-3.5 top-1/2 -translate-y-1/2 text-[#9fb1b2] transition-colors hover:text-[#1FA6A8]">
                    {show
