...
const COORDS: Record<string, [number, number]> = {
  ...
  "مكة المكرمة": [21.3891, 39.8579], "Makkah": [21.3891, 39.8579],
  "الشرقية": [26.2999, 50.2083], "المنطقة الشرقية": [26.2999, 50.2083], "Eastern Province": [26.2999, 50.2083],
  "المدينة المنورة": [24.5247, 39.5692], "Madinah": [24.5247, 39.5692],
  "عسير": [18.2465, 42.5117], "Asir": [18.2465, 42.5117],
  "القصيم": [26.3260, 43.9750], "Qassim": [26.3260, 43.9750],
  "جازان": [16.8892, 42.5511], "Jazan": [16.8892, 42.5511],
  "الجوف": [29.9697, 40.2064], "Al-Jouf": [29.9697, 40.2064],
  "جدة": [21.4858, 39.1925], "تبوك": [28.3838, 36.555],
};
