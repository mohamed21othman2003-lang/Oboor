...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "صفحة تفاصيل البرنامج", label_en: "Program Detail Page", href: "/cms/content/sections?page=program-detail", icon: "cap" },
      { label: "صفحة تفاصيل الخدمة", label_en: "Service Detail Page", href: "/cms/content/sections?page=service-detail", icon: "health" },
      { label: "صفحة تفاصيل التقنية", label_en: "Technique Detail Page", href: "/cms/content/sections?page=technique-detail", icon: "chip" },
      { label: "طلب التحاق", label_en: "Admission", href: "/cms/content/sections?page=admission", icon: "clipboard" },
