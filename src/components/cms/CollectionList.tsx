...
const PAGE_CHROME: Record<string, string> = { careers: "careers", success: "success", specialists: "specialists", branches: "branches", news: "news" };
...
const DEDICATED_PAGES = new Set(["about", "careers", "home", "success", "specialists", "assessment", "branches", "news"]);
