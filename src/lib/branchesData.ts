...
export const REGION_BRANCHES: Branch[] = [
  { slug: "kharj", name: "فرع الخرج", area: "حي الناصرية", city: "الخرج", region: "منطقة الرياض", address: "طريق الملك عبدالعزيز، حي الناصرية، الخرج", hours: HOURS, phone: "920000109", services: ["تخاطب ولغة", "تحليل سلوك", "التدخل المبكر"] },
  { slug: "wadi-dawasir", name: "فرع وادي الدواسر", area: "حي الفيصلية", city: "وادي الدواسر", region: "منطقة الرياض", address: "الطريق العام، حي الفيصلية، وادي الدواسر", hours: HOURS, phone: "920000109", services: ["علاج وظيفي", "تخاطب ولغة"] },
  { slug: "qassim", name: "فرع القصيم", area: "حي الصفراء", city: "القصيم", region: "منطقة القصيم", address: "طريق الملك فهد، حي الصفراء، بريدة", hours: HOURS, phone: "920000109", services: ["تحليل سلوك", "تكامل حسي", "تخاطب ولغة"] },
  { slug: "majmaah", name: "فرع المجمعة", area: "حي العزيزية", city: "المجمعة", region: "منطقة الرياض", address: "طريق الملك سلمان، حي العزيزية، المجمعة", hours: HOURS, phone: "920000109", services: ["علاج طبيعي", "علاج وظيفي"] },
  ...
  { slug: "jouf", name: "فرع الجوف", area: "حي الفيصلية", city: "الجوف", region: "منطقة الجوف", address: "طريق الملك عبدالله، حي الفيصلية، سكاكا", hours: HOURS, phone: "920000109", services: ["تحليل سلوك", "التدخل المبكر"] },
  { slug: "madinah", name: "فرع المدينة المنورة", area: "حي العزيزية", city: "المدينة المنورة", region: "منطقة المدينة المنورة", address: "طريق الملك عبدالعزيز، حي العزيزية، المدينة المنورة", hours: HOURS, phone: "920000109", services: ["تخاطب ولغة", "علاج وظيفي", "تكامل حسي"] },
  { slug: "taif", name: "فرع الطائف", area: "حي شهار", city: "الطائف", region: "منطقة مكة المكرمة", address: "طريق الملك فيصل، حي شهار، الطائف", hours: HOURS, phone: "920000109", services: ["علاج طبيعي", "تحليل سلوك"] },
  { slug: "aseer", name: "فرع عسير", area: "حي المنسك", city: "عسير", region: "منطقة عسير", address: "طريق الملك عبدالعزيز، حي المنسك، أبها", hours: HOURS, phone: "920000109", services: ["علاج وظيفي", "دعم نفسي", "تخاطب ولغة"] },
];

export const REGION_BRANCHES_EN: Branch[] = [
  { slug: "kharj", name: "Al-Kharj Branch", area: "Al-Nasiriyah District", city: "Al-Kharj", region: "Riyadh Region", address: "King Abdulaziz Road, Al-Nasiriyah District, Al-Kharj", hours: HOURS_EN, phone: "920000109", services: ["Speech & Language Therapy", "Applied Behavior Analysis", "Early Intervention"] },
  { slug: "wadi-dawasir", name: "Wadi Al-Dawasir Branch", area: "Al-Faisaliyah District", city: "Wadi Al-Dawasir", region: "Riyadh Region", address: "Main Road, Al-Faisaliyah District, Wadi Al-Dawasir", hours: HOURS_EN, phone: "920000109", services: ["Occupational Therapy", "Speech & Language Therapy"] },
  { slug: "qassim", name: "Qassim Branch", area: "Al-Safra District", city: "Qassim", region: "Qassim Region", address: "King Fahd Road, Al-Safra District, Buraidah", hours: HOURS_EN, phone: "920000109", services: ["Applied Behavior Analysis", "Sensory Integration", "Speech & Language Therapy"] },
  { slug: "majmaah", name: "Al-Majmaah Branch", area: "Al-Azizia District", city: "Al-Majmaah", region: "Riyadh Region", address: "King Salman Road, Al-Azizia District, Al-Majmaah", hours: HOURS_EN, phone: "920000109", services: ["Physical Therapy", "Occupational Therapy"] },
  ...
  { slug: "jouf", name: "Al-Jouf Branch", area: "Al-Faisaliyah District", city: "Al-Jouf", region: "Al-Jouf Region", address: "King Abdullah Road, Al-Faisaliyah District, Sakaka", hours: HOURS_EN, phone: "920000109", services: ["Applied Behavior Analysis", "Early Intervention"] },
  { slug: "madinah", name: "Madinah Branch", area: "Al-Azizia District", city: "Madinah", region: "Madinah Region", address: "King Abdulaziz Road, Al-Azizia District, Madinah", hours: HOURS_EN, phone: "920000109", services: ["Speech & Language Therapy", "Occupational Therapy", "Sensory Integration"] },
  { slug: "taif", name: "Taif Branch", area: "Shihar District", city: "Taif", region: "Makkah Region", address: "King Faisal Road, Shihar District, Taif", hours: HOURS_EN, phone: "920000109", services: ["Physical Therapy", "Applied Behavior Analysis"] },
  { slug: "aseer", name: "Asir Branch", area: "Al-Mansak District", city: "Asir", region: "Asir Region", address: "King Abdulaziz Road, Al-Mansak District, Abha", hours: HOURS_EN, phone: "920000109", services: ["Occupational Therapy", "Psychological Services", "Speech & Language Therapy"] },
];
