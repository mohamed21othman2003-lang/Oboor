    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          clip("text-workflow", "شاهد العملية كاملة من أولها لآخرها: تكتب في الحقل فتتغيّر «المعاينة الحيّة» بجانبك لحظيًا ← «حفظ التعديلات» ← يظهر تعديلك على صفحة الموقع الحقيقية بعد التحديث.", "Watch the whole process end-to-end: you type in the field and the “live preview” beside you updates instantly → “Save Changes” → your edit appears on the real site page after a refresh."),
      ...
      },
      {
        ...
        steps: [
          ...
          clip("image-workflow", "شاهد العملية كاملة من أولها لآخرها: فتح المحرّر ← قصّ الصورة يدويًا وتعديل ألوانها ← «اعتماد» ← «حفظ التعديلات» ← تظهر الصورة المعدّلة على صفحة الموقع الحقيقية بعد التحديث.", "Watch the whole process end-to-end: open the editor → crop the image freely and adjust its colours → “Apply” → “Save Changes” → the edited image appears on the real site page after a refresh."),
