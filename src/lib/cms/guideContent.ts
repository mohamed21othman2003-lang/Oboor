    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          pl("محرّر الصور: بجانب كل صورة زر «تعديل الصورة» يفتح محرّرًا كاملًا فيه معاينة حيّة للصورة تتغيّر مع كل تعديل. يمكنك:", "Image editor: next to each image a “Edit Image” button opens a full editor with a live preview of the image that updates as you tweak. You can:", [
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          pl("قصص نجاح الفرع (نظام هجين): من داخل قسم «قصص النجاح» في محرّر الفرع تتحكّم في القصص التي تظهر لهذا الفرع بطريقتين معًا:", "Branch success stories (hybrid): inside the “Success stories” section of the branch editor you control which stories show for this branch in two ways together:", [
