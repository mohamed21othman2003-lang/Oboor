...
const BASE: Record<string, string> = {
  ...
  map_url: "Map Link",
  success_heading: "Success Stories Heading",
  success_sub: "Success Stories Text",
  success_story_slugs: "Selected stories from Oboor Champions",
  success_stories: "Branch-specific success stories",
  rating: "Rating",
