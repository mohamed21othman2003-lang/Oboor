...
class SectionItem(models.Model):
    ...
    badge1_label_ar = models.CharField("الشارة الأولى — العنوان الصغير (عربي)", max_length=120, blank=True, default="")
    badge1_label_en = models.CharField("الشارة الأولى — العنوان الصغير (إنجليزي)", max_length=120, blank=True, default="")
    badge1_value_ar = models.CharField("الشارة الأولى — النص الكبير (عربي)", max_length=120, blank=True, default="")
    badge1_value_en = models.CharField("الشارة الأولى — النص الكبير (إنجليزي)", max_length=120, blank=True, default="")
    badge2_label_ar = models.CharField("الشارة الثانية — العنوان الصغير (عربي)", max_length=120, blank=True, default="")
    badge2_label_en = models.CharField("الشارة الثانية — العنوان الصغير (إنجليزي)", max_length=120, blank=True, default="")
    badge2_value_ar = models.CharField("الشارة الثانية — النص الكبير (عربي)", max_length=120, blank=True, default="")
    badge2_value_en = models.CharField("الشارة الثانية — النص الكبير (إنجليزي)", max_length=120, blank=True, default="")
...
class ServiceCard(models.Model):
    ...
    badge_ar = models.CharField("الشارة (عربي)", max_length=120, blank=True, default="")
    badge_en = models.CharField("الشارة (إنجليزي)", max_length=120, blank=True, default="")
    ...
    age_ar = models.CharField("الفئة العمرية (عربي)", max_length=120, blank=True, default="")
    age_en = models.CharField("الفئة العمرية (إنجليزي)", max_length=120, blank=True, default="")
